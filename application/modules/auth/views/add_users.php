...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="card card-default">
      ...
      <!-- /.card-header -->
      <div class="card-body">
        <?php echo form_open_multipart(base_url('publications/save'), array('id' => 'user_form', 'class' => 'user_form')); ?>

        <div class="row">
          <div class="col-md-12">
            <button type="submit" class="btn btn-warning btn-outline" style="color:#FFF;">Save</button>
