...
<div class="modal fade" id="create-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open_multipart(base_url('forms/save_form_data'), array('id' => $label, 'class' => $label)); ?>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="name"><?php echo $label_parent; ?></label>
                            <select class="form-control" name="<?php echo $parent_name ?>">
