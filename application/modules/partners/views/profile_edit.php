<div class="card card-default" data-select2-id="32">
    ...
    <div class="card-body">
        ...
        <?php 
            $partners_ids = array_column($profile->partners,"id");
            $partners_funders = array_column($profile->funders,"id");
            $partner_activities = array_column($profile->activities,"ids");
        ?>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    value="<?php echo $profile->project;?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" style="width: 100%;" name="partner[]" tabindex="-1" aria-hidden="true" multiple required>
                        <?php foreach ($partners as $row) : ?>
                            <option <?php echo (in_array($row->id,$partners_ids))?"selected":""; ?> value="<?php echo $row->id; ?>"><?php echo $row->name; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="funder[]" style="width: 100%;" tabindex="-1" aria-hidden="true" multiple>
                        ...
                        <?php foreach ($funders as $row) : ?>
                            <option  <?php echo (in_array($row->id,$partners_funders))?"selected":""; ?> value="<?php echo $row->id; ?>"><?php echo $row->name; ?></option>
                        <?php endforeach; ?>
                        <?php
                ...
                <div class="form-group">
                    ...
                    value="<?php echo $profile->organisation_telephone;?>">
                </div>
                <div class="form-group">
                    <label for="Oganisation">Postal Address </label>
                    <textarea class="form-control" name="postal_address"><?php echo $profile->postal_address;?></textarea>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div id="contact" style="max-height: 600px; overflow:auto;">
                            ...
                            <select class="form-control mb-2" name="person_title">
                                <option <?php echo ($profile->contact_person_title=="Mr.")?"selected":""; ?>>Mr.</option>
                                <option <?php echo ($profile->contact_person_title=="Mrs.")?"selected":""; ?>>Mrs.</option>
                                <option <?php echo ($profile->contact_person_title=="Dr.")?"selected":""; ?>>Dr.</option>
                                <option <?php echo ($profile->contact_person_title=="Pr.")?"selected":""; ?>>Pr.</option>
                                <option <?php echo ($profile->contact_person_title=="Ms")?"selected":""; ?>>Ms.</option>
                                <option <?php echo ($profile->contact_person_title=="Hon")?"selected":""; ?>>Hon.</option>
                            </select>
                            <input type="text" name="name" class="form-control mb-2" placeholder="Name" class="form-group" required value="<?php echo $profile->contact_person_name;?>"/>
                            <input type="text" class="form-control mb-2" placeholder="Phone Number" name="phone_number" class="form-group mb-2" required  value="<?php echo $profile->contact_phone_number;?>"/>
                            <input type="text" class="form-control mb-2" name="email" placeholder="Email" class="form-group mb-2" required value="<?php echo $profile->email?>"/>
                            <input type="text" class="form-control mb-2" name="position" placeholder="Position or Job" required value="<?php echo $profile->contact_position;?>" />
                        </div>
                ...
                <div id="theme" style="max-height: 600px; overflow:auto;">
                    ...
                    <br>
                <hr style="border-bottom: 1px solid #400;"/>
                <div class="form-group theme">
                    <label>Thematic Area</label>
                    <select class="form-control mb-2 select2"   name="theme[]">
                    <?php foreach ($areas as $row) : ?>
                    <option <?php echo (in_array($row->id,$partner_activities ))?"selected":""; ?>  value="<?php echo @$row->id; ?>"><?php echo @$row->name; ?> </option>
                    <?php endforeach; ?>
                </select></div>
