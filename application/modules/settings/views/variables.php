<div class="col-md-12" style=" background:white; border-radius: 5px;">
  ...
  ?> <div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
      <li class="active"><a href="<?php echo base_url(); ?>svariables/index">System Variables</a></li>
...
<div class="col-md-12">
  <form method="post" action="<?php echo base_url(); ?>setting/index" autocomplte="off">
